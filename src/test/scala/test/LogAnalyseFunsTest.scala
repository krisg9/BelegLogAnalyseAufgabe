...
class LogAnalyseFunsTest extends AnyFunSuite with BeforeAndAfterAll{
  
  var session:org.apache.spark.sql.SparkSession=_
  ...
  test("Response Codes Per Day"){
   ...
   test("Average Number Of Requests Per Week Day"){
    ...
    //falsch: assert(res===List((57589,"Montag"), (52685,"Dienstag"), (58554,"Mittwoch"), (53870,"Donnerstag"), (59013,"Freitag"), (34016,"Samstag"), (33953,"Sonntag")))
